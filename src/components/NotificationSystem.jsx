...
const NotificationContainer = () => {
  ...
  const getNotificationStyles = (type) => {
    ...
    switch (type) {
      case 'success':
        return `${baseStyles} bg-green-50 border-green-400 ${darkMode ? 'bg-green-800 border-green-500' : ''}`;
      case 'error':
        return `${baseStyles} bg-red-50 border-red-400 ${darkMode ? 'bg-red-800 border-red-500' : ''}`;
      case 'warning':
        return `${baseStyles} bg-yellow-50 border-yellow-400 ${darkMode ? 'bg-yellow-900 border-yellow-500' : ''}`;
      case 'info':
      default:
        return `${baseStyles} bg-blue-50 border-blue-400 ${darkMode ? 'bg-blue-800 border-blue-500' : ''}`;
    }
  };
