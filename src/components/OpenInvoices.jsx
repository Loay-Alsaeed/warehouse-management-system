...
const OpenInvoices = ({ onEditInvoice, onAddInvoice }) => {
  ...
  const handlePaymentComplete = async (paymentData) => {
    ...
    try {
      ...
      // Prepare invoice data for final invoices collection (omit open-invoice doc id from stored fields)
      const { id: _openInvoiceDocId, ...invoiceFields } = invoiceForPayment;
      const invoiceData = {
        ...invoiceFields,
